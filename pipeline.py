...
if __name__ == '__main__':
    ...
    imagesFolder = "/home/zqr/codes/data/processed_Videos"
    ...
    # step1: 切帧
    # runStatus = os.system('python3 getFrames.py {} {}'.format(videosFolder, imagesFolder))
    # if runStatus != 0:
    #     print("切帧流程错误")
    #     sys.exit(1)
    # print("切帧流程完成")
    ...
    # runStatus = os.system('python3 getBbox.py {} {}'.format(videosBboxPath, imagesFolder))
    # if runStatus != 0:
    #     print("检测候选框流程错误")
    #     sys.exit(1)
    # print("检测候选框流程完成")
    ...
    # runStatus = os.system('python3 processMyVideos.py {} {} {}'.format(videosBboxPath, imagesFolder_160, videosFolder))
    # if runStatus != 0:
    #     print("重构160流程错误")
    #     sys.exit(1)
    # print("重构160流程完成")
    ...
    runStatus = os.system('python3 run.py {} {} {}'.format(imagesFolder_160, opticalFolder, dataInfoPath))
    if runStatus != 0:
        print("光流法提取特征错误")
        sys.exit(1)
    print("光流法提取特征完成")

    # step4*：将光流图重构为160×160
